      ...
      {countrySearch.length > 0 ? (
        <div className="detail__container">
          ...
          <div className="detail__description">
            ...
            <p>
              <span>Languages</span>
              {Object.values(countrySearch[0].languages).map((item) => item).join(',')}
            </p>
            <p>
              <span>Currencies</span>
              {Object.values(countrySearch[0].currencies).map((item) => item.name).join(',')}
            </p>
            <p>
              <span>Time Zone</span>
            ...
            <p>
              <span>Map</span>
              <a href={countrySearch[0].maps.googleMaps} style={{ color: '#0050e4' }}>Google Map</a>
            </p>
            <p>
